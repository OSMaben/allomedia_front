                    ...
                    <div className="flex flex-col items-center justify-center mb-3">
                        {!gameStarted && (
                            <p className="text-[12px] text-[#807E7E] ">
                                Press <span
                                className="px-3 py-1 m-0 bg-gray-900 border border-[#2E2E2E] text-white rounded">SPACE</span> to
                                play
                            </p>
                        )}
                            ...
                            <div className="flex items-center space-x-1 justify-center">
                                ...
                                <div className="grid grid-cols-4 gap-1 ml-2">
                                    <button
                                        ...
                                        onClick={() => setDirection({x: -1, y: 0})}><FaAngleLeft size={12}/></button>
                                    <button
                                        className="bg-gray-900 border border-[#2E2E2E] rounded text-[#807E7E] text-center p-1 focus:outline-none"
                                        onClick={() => setDirection({x: 1, y: 0})}><FaAngleRight size={12}/></button>
                                    <button
                                        className="bg-gray-900 border border-[#2E2E2E] rounded text-[#807E7E] text-center p-1 focus:outline-none"
                                        onClick={() => setDirection({x: 0, y: -1})}><FaAngleUp size={12}/></button>
                                    <button
                                        className="bg-gray-900 border border-[#2E2E2E] rounded text-[#807E7E] text-center p-1 focus:outline-none"
                                        onClick={() => setDirection({x: 0, y: 1})}><FaAngleDown size={12}/></button>
                                </div>
                            </div>
                        )}
                    </div>
